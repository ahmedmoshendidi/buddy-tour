...
export default function TourDetails() {
  ...
  const seoProps =
    loading
      ? {
          title: 'Tour details | BuddyTour',
          description: 'Explore guided tours in Alexandria with BuddyTour.',
          url: pageUrl,
        }
      : tour
      ? {
          title: `${tour.title} - BuddyTour`,
          description: tour.description,
          image: tour.image_urls?.[0],
          url: pageUrl,
          canonical: `https://buddytourguide.com/tour/${tour.slug || tour.id}`,
        }
      : undefined;
