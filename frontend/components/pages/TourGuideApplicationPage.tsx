...
interface TourGuideApplicationPageProps {
  onBackToHome: () => void;
}
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Describe any previous tour guide experience (can be informal). If none, explain your interest in starting."
                      />
                    </div>
